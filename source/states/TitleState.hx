		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					...
					#else
					createCoolText(['Average PC', 'Mod Mix']);
					#end
				case 4:
					#if PSYCH_WATERMARKS
				...
				case 6:
					...
					#else
					createCoolText(['Not supporting', 'the thing called'], -40);
					#end
				case 8:
					addMoreText('Skbidi Toilet', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
				...
				case 15:
					addMoreText('PC');
				case 16:
					addMoreText('Engine YEAH'); // credTextShit.text += '\nFunkin';
